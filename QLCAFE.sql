...
('HD001','1','KH003',NULL,'20/7/2021',N'KHÔNG ĐỔI'),
('HD002','2','KH002',NULL,'20/8/2021',N'KHÔNG ĐỔI'),
('HD003','3','KH001',NULL,'20/1/2021',N' ĐỔI TRẢ')

ALTER TABLE CTHOADON
ADD THANHTIEN float default null

INSERT INTO CTHOADON VALUES
('HD001','SP002',10,20000,200000),
('HD001','SP001',5,30000,150000),
('HD002','SP003',20,20000,400000),
('HD002','SP004',10,20000,200000),
('HD003','SP001',30,30000,900000)
...
CREATE trigger TONGTIENCTHD on CTHOADON
    ...
    begin
    	update CTHOADON
    	set 
    		THANHTIEN = inserted.SoLuong * CTHOADON.GIA
    	from 
    		inserted,
    		SANPHAM, 
    		CTHOADON,
    	...
    	where 
    		...
    		and (SANPHAM.MASP = CTHOADON.MASP) and CTHOADON.MAHD=HOADON.MAHD
    end
...
Exec LoginV1'admin','1'

SELECT * FROM NHANVIEN WHERE TENTK = 'admin' AND PASSWD = '1'
CREATE PROC THEMSP
(
	@TENSP NVARCHAR(100),
	@GIA FLOAT,
